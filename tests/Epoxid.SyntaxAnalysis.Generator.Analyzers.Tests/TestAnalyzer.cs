using Test = Microsoft.CodeAnalysis.CSharp.Testing.CSharpAnalyzerTest<
    Epoxid.SyntaxAnalysis.Generator.Analyzers.AstSwitchAnalyzer,
    Microsoft.CodeAnalysis.Testing.DefaultVerifier>;

namespace Epoxid.SyntaxAnalysis.Generator.Analyzers.Tests;
...
public class TestAnalyzer
{
    ...
    namespace Bau
    {
        [Epoxid.SyntaxAnalysis.WildUnion(typeof(FuzzyView), typeof(FluffyView))]
        interface BauBauView;

        [Epoxid.SyntaxAnalysis.BaseRule(typeof(FuwView), typeof(AwaView))]
        class FluffyView;
