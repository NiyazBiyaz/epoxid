...
/// <summary>
/// Node class that represents <i>ParenthesizedAsyncWithStatement</i>.
/// </summary>
public sealed partial record ParenthesizedAsyncWithStatementNode : WithStatementNode
{
    ...
    public NodeArray<GreenNode> SeparatedItems => (NodeArray<GreenNode>)Children![3];
...
/// <summary>
/// View class that represents <i>ParenthesizedAsyncWithStatement</i>.
/// </summary>
    ...
    public ViewArray<RedView> SeparatedItems
    {
        get
        {
            if (_ast_field_items == null)
            {
                ...
                _ast_field_items = new ViewArray<RedView>(((ParenthesizedAsyncWithStatementNode)base.Green).SeparatedItems, _positionOfField, this);
            }
