...
/// <summary>
/// Node class that represents <i>ParenthesizedWithItems</i>.
/// </summary>
public sealed partial record ParenthesizedWithItemsNode : WithItemsNode
{
    ...
    public override ParenthesizedWithItemsView GetView(int position, IRedView? parent)
        => new ParenthesizedWithItemsView(this, position, parent);
}

/// <summary>
/// View class that represents <i>ParenthesizedWithItems</i>.
/// </summary>
public sealed partial class ParenthesizedWithItemsView : WithItemsView
{
    public ParenthesizedWithItemsView(ParenthesizedWithItemsNode green, int position, IRedView? parent)
    ...
    public ViewArray<RedView> SeparatedItems
    {
        get
        {
            if (_ast_field_items == null)
            {
                ...
                _ast_field_items = new ViewArray<RedView>(((ParenthesizedWithItemsNode)base.Green).SeparatedItems, _positionOfField, this);
            }
