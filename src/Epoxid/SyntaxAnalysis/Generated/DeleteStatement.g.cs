...
/// <summary>
/// Node class that represents <i>DeleteStatement</i>.
/// </summary>
public sealed partial record DeleteStatementNode : GreenNode, ISimpleStatementNode
{
    ...
    public global::System.Collections.Immutable.ImmutableArray<DeleteTargetNode> Targets
    {
        get
        {
            ...
            {
                var _tmp = SeparatedTargets.Where(static (_, i) => i % 2 == 0).Cast<DeleteTargetNode>();
...
/// <summary>
/// View class that represents <i>DeleteStatement</i>.
/// </summary>
public sealed partial class DeleteStatementView : RedView, ISimpleStatementView
{
    ...
    public ViewArray<RedView> SeparatedTargets
    {
        get
        {
            if (_ast_field_targets == null)
            {
                ...
                _ast_field_targets = new ViewArray<RedView>(((DeleteStatementNode)base.Green).SeparatedTargets, _positionOfField, this);
            }
    ...
    public global::System.Collections.Immutable.ImmutableArray<DeleteTargetView> Targets
    {
        get
        {
            ...
            {
                var _tmp = SeparatedTargets.Where(static (_, i) => i % 2 == 0).Cast<DeleteTargetView>();
                _field_targets = global::System.Collections.Immutable.ImmutableArray.ToImmutableArray(_tmp);
            }
            return _field_targets.Value;
        }
