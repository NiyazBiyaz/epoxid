...
public record FunctionParametersDescription
{
    ...
    /// In Epoxid this is a parameters declared before slash <c>/</c> symbol in function signature.
    /// </summary>
    ...
    /// In Epoxid this is a parameters declared before <c>*</c> symbol or variadic argument and, if there are,
    ...
    /// In Epoxid this is a parameter declared with star <c>*</c> symbol.
    /// </summary>
    /// <remarks>
    ...
    /// In Epoxid this is a parameters declared after star <c>*</c> symbol or variadic argument.
    /// </summary>
    ...
    /// In Epoxid this is a parameter declared with double star <c>**</c> symbol.
    /// </summary>
    /// <remarks>
    ...
    public bool ArgumentsAreValid(int argCount, EpDict kwargs, [NotNullWhen(false)] out string? message)
    {
        ...
        {
            string keyStr = ((EpString)key).Value;
