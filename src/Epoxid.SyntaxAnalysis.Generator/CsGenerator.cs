...
internal class CsGenerator(string accessModifier)
{
    ...
    private void addNodeType(TypeIr ir)
    {
        ...
        if (ir.IsAbstract.Value)
        {
            ...
            addLine($"[global::Epoxid.SyntaxAnalysis.BaseRule({string.Join(", ", nodeInheritorNames)})]");
        }
        ...
        if (ir.IsAbstract.Value)
        {
            ...
            addLine($"[global::Epoxid.SyntaxAnalysis.BaseRule({string.Join(", ", viewInheritorNames)})]");
        }
    ...
    private void addUnionType(TypeIr ir)
    {
        ...
        addLine($"[global::Epoxid.SyntaxAnalysis.WildUnion({string.Join(", ", typeofNodeMemberNames)})]");
        ...
        addLine($"[global::Epoxid.SyntaxAnalysis.WildUnion({string.Join(", ", typeofViewMemberNames)})]");
