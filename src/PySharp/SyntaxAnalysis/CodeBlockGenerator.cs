...
internal class CodeBlockGenerator(IEnumerable<IStatementView> statements)
{
        ...
        switch (arithmetic)
        {
            ...
            case AtomPrimaryView atom:
                return atom.Atom switch
                {
                    ...
                    NoneAtomView => Builder.LdConst(PsConstants.None),

                    TrueAtomView => Builder.LdConst(PsConstants.True),

                    FalseAtomView => Builder.LdConst(PsConstants.False),

                    EllipsisAtomView => Builder.LdConst(PsConstants.Ellipsis),
    ...
    private IntermediateInstruction loadNumber(string numberString)
    {
        ...
        {
            NumberType.Integer => (PsInteger)NumberParser.ParseInteger(numberString),
            NumberType.Float => (PsFloat)NumberParser.ParseFloat(numberString),
    ...
    private IntermediateInstruction loadString(StringValueAtomView str)
    {
        ...
        return Builder.LdConst((PsString)strValue);
    }
    ...
    private IntermediateInstruction generateCall(CallWithArgumentsPrimaryView call)
    {
        ...
        {
            firstArgument = Builder.LdConst(PsConstants.None).Dest!;
        }
